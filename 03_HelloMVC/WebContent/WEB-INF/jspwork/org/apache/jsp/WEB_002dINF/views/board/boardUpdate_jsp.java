 ...
 * Generated at: 2018-12-21 12:27:28 UTC
...
if(memberLoggedIn == null){ 
	...
	Board b = (Board)request.getAttribute("board");
      ...
      out.write("\t\t\talert(\"내용을 작성하세요.\");\r\n");
      out.write("\t\t\tcontent.focus();\r\n");
      out.write("\t\t\treturn false; // 폼전송 방지\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\treturn true;\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tconsole.log($(this).val()); // 선택된 경우 가짜 파일 경로가 나온다. 보안적인 이유로 실제 디렉토리가 안 나옴 또는 \"\" 이게 나옴\r\n");
      ...
      out.write("\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/board/boardUpdateEnd\"\r\n");
      out.write("\t\tmethod=\"post\"\r\n");
      out.write("\t\tenctype=\"multipart/form-data\" > <!-- 파일업로드를 위한 필수속성(이게 빠지면 파일이 안 넘어감) -->\r\n");
      ...
      out.print(b.getOriginalFileName()!=null?b.getOriginalFileName():"" );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<!-- 파일 변경시 삭제 -->\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"old_renamed_file\" \r\n");
      out.write("\t\t\t\t\t\t   value=\"");
      out.print(b.getRenamedFileName() );
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"old_original_file\"\r\n");
      out.write("\t\t\t\t\t\t   value=\"");
...
if(b.getOriginalFileName() != null){ 
      ...
      out.write("\t\t\t\t\t<br />\r\n");
      out.write("\t\t\t\t\t<input type=\"checkbox\" \r\n");
      out.write("\t\t\t\t\t\t   name=\"del_file\" id=\"del_file\" />\r\n");
      ...
      out.write("\t\t\t\t<th>내 용</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<textarea rows=\"5\" cols=\"50\" name=\"content\">");
